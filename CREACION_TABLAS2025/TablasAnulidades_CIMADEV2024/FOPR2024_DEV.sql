...
-- Tiempo de generación: 20-11-2024 a las 16:48:19
...
--
-- Estructura de tabla para la tabla `FOPR2024`
--

DROP TABLE IF EXISTS `FOPR2024`;
CREATE TABLE `FOPR2024` (
...
--
-- Indices de la tabla `FOPR2024`
--
ALTER TABLE `FOPR2024`
