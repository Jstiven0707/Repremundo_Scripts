...
-- Tiempo de generación: 22-11-2024 a las 11:30:45
...
--
-- Estructura de tabla para la tabla `DVLA2024`
--

DROP TABLE IF EXISTS `DVLA2024`;
CREATE TABLE `DVLA2024` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='SALDOS DE FACTURA CLIENTE, FACTURA, ITEM VS LOTES SIN AUTORIZAR' ROW_FORMAT=COMPACT;
...
--
-- Indices de la tabla `DVLA2024`
--
ALTER TABLE `DVLA2024`
