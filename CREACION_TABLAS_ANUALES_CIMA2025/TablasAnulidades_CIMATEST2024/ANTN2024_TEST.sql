...
-- Tiempo de generación: 20-11-2024 a las 15:10:50
...
--
-- Estructura de tabla para la tabla `ANTN2024`
--

CREATE TABLE `ANTN2024` (
...
--
-- Indices de la tabla `ANTN2024`
--
ALTER TABLE `ANTN2024`
