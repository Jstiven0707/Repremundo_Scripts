...
--
-- Estructura de tabla para la tabla `RECS2025`
--

DROP TABLE IF EXISTS `RECS2025`;
CREATE TABLE `RECS2025` (
  ...
  `RECSCOBU` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'UBICACION DEL PRODUCTO',
...
--
-- Indices de la tabla `RECS2025`
--
ALTER TABLE `RECS2025`
