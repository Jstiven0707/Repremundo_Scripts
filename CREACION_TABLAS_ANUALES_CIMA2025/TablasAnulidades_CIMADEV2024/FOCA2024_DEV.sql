...
-- Tiempo de generación: 20-11-2024 a las 16:45:21
...
--
-- Estructura de tabla para la tabla `FOCA2024`
--

DROP TABLE IF EXISTS `FOCA2024`;
CREATE TABLE `FOCA2024` (
...
--
-- Indices de la tabla `FOCA2024`
--
ALTER TABLE `FOCA2024`
  ADD PRIMARY KEY (`FOCOIDXX`,`ALCIDXXX`,`FOCOVERX`) USING BTREE,
  ADD KEY `FOCOVERX` (`FOCOVERX`),
  ADD KEY `ALCIDXXX` (`ALCIDXXX`) USING BTREE,
