...
CREATE TABLE `SIAI0206` (
  ...
  `LIMEDAFX` datetime NOT NULL COMMENT 'Envio Declaraciones API Falabella',
  `LIMEABLE` datetime NOT NULL COMMENT 'Evento Api Bancolombia Levante',
...
ALTER TABLE `SIAI0206`
  ADD PRIMARY KEY (`DOIIDXXX`,`DOISFIDX`,`ADMIDXXX`,`SUBID2XX`),
  ADD KEY `CLIIDXXX` (`CLIIDXXX`),
  ADD KEY `LIMCCTXX` (`LIMCCTXX`),
  ADD KEY `DOIID2XX` (`DOIID2XX`),
  ADD KEY `LIMLEVXX` (`LIMLEVXX`,`LIMFLEVX`,`LIMRFSLE`,`REGSYNCM`),
  ADD KEY `LIMLEVXX2` (`LIMLEVXX`),
  ADD KEY `LIMSTKXX` (`LIMSTKXX`),
  ADD KEY `LIMSTKAX` (`LIMSTKAX`),
  ADD KEY `LIMFSTKX` (`LIMFSTKX`),
  ADD KEY `LIMFLEVX` (`LIMFLEVX`),
  ADD KEY `LIMACEXX` (`LIMACEXX`),
  ADD KEY `LIMFACEX` (`LIMFACEX`),
  ADD KEY `LIMESRG1` (`LIMESRGX`,`LIMLEVXX`,`LIMFLEVX`,`LIMHLEVX`,`LIMTLEVX`),
  ADD KEY `LIMEFXNP` (`LIMEFXNP`,`LIMLEVXX`,`LIMFLEVX`,`LIMHLEVX`),
  ADD KEY `LIMEXIVI` (`LIMEXIVI`,`LIMFLEVX`,`LIMHLEVX`),
  ADD KEY `LIMGILCX` (`LIMLEVXX`,`LIMFLEVX`,`LIMHLEVX`,`LIMTLEVX`,`LIMGILCC`),
  ADD KEY `LIMTLEVX` (`LIMTLEVX`),
  ADD KEY `LIMGILCC` (`LIMGILCC`),
  ADD KEY `LIMSIPLA` (`LIMSIPLA`),
  ADD KEY `ARCLIMSI` (`ARCIDXXX`,`LIMSIPLA`),
  ADD KEY `LIMFTALX` (`LIMLEVXX`,`LIMFLEVX`,`LIMHLEVX`,`LIMFTALX`,`REGESTXX`),
  ADD KEY `LIMEDAFX` (`LIMEDAFX`),
  ADD KEY `LIMEDAFC` (`CLIIDXXX`,`LIMEDAFX`,`LIMLEVXX`,`LIMFLEVX`,`LIMHLEVX`,`LIMTLEVX`),
  ADD KEY `LIMEABLE` (`LIMEABLE`),
  ADD KEY `CLILEEAB` (`CLIIDXXX`,`LIMLEVXX`,`LIMFLEVX`,`LIMHLEVX`,`LIMTLEVX`,`LIMEABLE`);
ALTER TABLE `SIAI0206` ADD FULLTEXT KEY `LIMROB3X` (`LIMROB3X`);
ALTER TABLE `SIAI0206` ADD FULLTEXT KEY `LIMROB4X` (`LIMROB4X`);
COMMIT;
