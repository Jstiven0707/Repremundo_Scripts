...
-- Tiempo de generación: 23-01-2025 a las 14:55:58
...
CREATE TABLE `CIPF0018` (
  ...
  `CONANTXX` enum('','SIN ANTICIPO','CON ANTICIPO','POR OPERACION','CON ANTICIPO GLOBAL','CONDICIONES DEL ANTICIPO') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT ' CLIENTE VS DATOS GENERALES DE LA OPERACION',
  `CLICORFA` tinytext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'correo de facturacion principal',
