...
-- Tiempo de generación: 14-05-2026 a las 13:44:51
...
CREATE TABLE IF NOT EXISTS `SIAI0206` (
  ...
  `LIMNUSHX` varchar(100) NOT NULL COMMENT 'Shipment Number CW1',
  `LIMGUSRA` date NOT NULL COMMENT 'Generacion Universal Shipment Radicado',
  `LIMGUSAC` date NOT NULL COMMENT 'Generacion Universal Shipment Aceptacion',
  `LIMGUSST` date NOT NULL COMMENT 'Generacion Universal Shipment Autoadhesivo',
  `LIMGUSLE` date NOT NULL COMMENT 'Generacion Universal Shipment Levante',
