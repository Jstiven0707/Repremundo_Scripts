...
-- Tiempo de generación: 14-07-2025 a las 11:41:10
...
CREATE TABLE `RLCA2025` (
  ...
  `MDRERIGM` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tipo de Regimen',
  ...
  `MDRPBNMC` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Código Cupo Mincit',
  `MDREAPPV` enum('','SI','NO') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Bandera Aplica Plan Vallejo',
  `TIPSOPRO` enum('','SI','NO') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tipo de solicitud programa',
  `TIPSOREP` enum('','SI','NO') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tipo de solicitud reposicion',
  `CLINUMPR` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'NUMERO DE PROGRAMA',
  `MDRENUMR` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Numero de Reposición',
  ...
  `ENTVISID` smallint NOT NULL COMMENT 'ID ENTIDAD (CIPO0010)',
  `RLCAXMLX` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Path archivo xml transmision vuce',
  `RLCADOCC` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Path Paquete de Documentos Genio',
  `RLCAAPVB` enum('','SI','NO') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'BANDERA QUE INDICA SI APLICA VISTOS BUENOS',
  `RLCAFERA` date NOT NULL COMMENT 'Fecha Radicacion',
  `PDFPATHX` tinytext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'path pdf',
  `GENPDFXX` enum('','SI','NO') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Bandera que indica si el pdf esta siendo generado',
  `RLCATIPR` enum('REGISTRO DE IMPORTACION','MODIFICACION DE REGISTRO','PRORROGA DEL REGISTRO') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tipo de Registro',
  `RLCADOAN` int NOT NULL COMMENT 'Numero del Do Anterior',
  `RLCAOPEN` enum('','SI','NO') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Bandera que indica si el Registro se trabaja en Open',
  `RLCAESVU` tinytext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Estado Vuce',
  `RLDPAPDA` enum('','SI','NO') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'BANDERA QUE INDICA SI APLICA DOCUMENTOS ADICIONALES',
