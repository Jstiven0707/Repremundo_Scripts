CREATE TABLE IF NOT EXISTS `MDOS2025` (
  ...
  `DOCCLOXX` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `DOIPEDXX` varchar(300) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Numero Pedido',
  ...
  `DOCFCODX_OLD` text COLLATE utf8_unicode_ci NOT NULL,
  ...
  `DESVERCA` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Descripcion de Verificación a la Carga ',
  `DOCNCART` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Numero Carta Porte Expo',
  ...
  `DOCHRCFX` date NOT NULL DEFAULT '0000-00-00' COMMENT 'Fecha de salida de ultima unidad de carga',
  ...
  `DOCDHRCD` date NOT NULL DEFAULT '0000-00-00' COMMENT 'Fecha de descargue en ZF',
  ...
  `DIHUAWEI` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'descripcion de la inconsistencia',
  `NUMPACLI` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'PACKING LIST HUAWE',
  ...
  `DOCNUMAT` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Numero de Manifiesto para OTM y DTA',
  ...
  `DOCSELDX` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'POSICION',
  ...
  `DOCTRAPR` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'NUMERO PO',
  ...
  `DESCOTIN` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Descripcion otra inspeccion',
  ...
  `DOCNUVIA` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'NUMERO MIGO',
  ...
  `DOCESTCX` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Descripcion del Estado del cliente',
  ...
  `MERCEMBA` date NOT NULL DEFAULT '0000-00-00' COMMENT 'Fecha Descargue de mercancía en bodegas del Cliente',
  ...
  `ASUCREDO` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Asunto del correo con el que se creo el DO',
  ...
  `CUPOARXX` enum('','SI','NO') COLLATE utf8_unicode_ci NOT NULL,
