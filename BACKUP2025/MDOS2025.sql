CREATE TABLE `MDOS2025` (
  ...
  `MDOSBALF` enum('','SI','NO') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Bandera que indica si la operacion esta lista para facturar',
  `MDOSJUFA` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Justificacion de facturacion',
