...
-- Tiempo de generación: 20-11-2024 a las 12:34:17
...
--
-- Estructura de tabla para la tabla `ANTE2024`
--

CREATE TABLE `ANTE2024` (
...
--
-- Indices de la tabla `ANTE2024`
--
ALTER TABLE `ANTE2024`
  ADD PRIMARY KEY (`ANTCIDXX`,`DOCNROXX`,`CONIDXXX`),
