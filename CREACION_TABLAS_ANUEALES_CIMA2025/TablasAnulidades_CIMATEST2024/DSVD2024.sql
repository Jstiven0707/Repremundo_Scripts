...
-- Tiempo de generación: 22-11-2024 a las 11:24:45
...
DROP TABLE IF EXISTS `DSVD2024`;
CREATE TABLE `DSVD2024` (
  ...
  `CANDAVXX` decimal(23,5) NOT NULL COMMENT 'CANTIDAD DAV',
  `UNIIDXXX` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ID DE LA UNIDAD',
  `CANITEXX` decimal(23,5) NOT NULL COMMENT 'CANTIDAD ITEM',
  `VALUNIIT` decimal(23,5) NOT NULL COMMENT 'valor unitario',
  `VALTOTIT` decimal(23,5) NOT NULL COMMENT 'valor Total',
  `PESBRUIT` decimal(23,5) NOT NULL COMMENT 'peso bruto',
  `PESNETIT` decimal(23,5) NOT NULL COMMENT 'peso neto',
  ...
  `FOBGASIT` decimal(23,5) NOT NULL COMMENT 'valor FOB gastos facturados',
  `FLEGASIT` decimal(23,5) NOT NULL COMMENT 'valor FLETE gastos facturados',
  `CONGASIT` decimal(23,5) NOT NULL COMMENT 'valor CONEXOS gastos facturados',
  `SEGGASIT` decimal(23,5) NOT NULL COMMENT 'valor SEGUROS gastos facturados',
  `VARGASIT` decimal(23,5) NOT NULL COMMENT 'valor VARIOS gastos facturados',
...
--
-- Indices de la tabla `DSVD2024`
--
ALTER TABLE `DSVD2024`
