...
ALTER TABLE `CIPO0214`
  ADD PRIMARY KEY (`CLIIDXXX`,`IDPROXXX`,`TIPPROID`,`TIPOVARX`,`NOMBVARX`);
  ADD KEY `IDX_CLIIDXXX` (`CLIIDXXX`),
  ADD KEY `IDX_IDPROXXX` (`IDPROXXX`),
  ADD KEY `IDX_TIPPROID` (`TIPPROID`),
  ADD KEY `IDX_TIPOVARX` (`TIPOVARX`);
COMMIT;



ALTER TABLE `CIPO0214`
MODIFY COLUMN NOMBVARX VARCHAR(30) NOT NULL COMMENT'Nombre Variable';
