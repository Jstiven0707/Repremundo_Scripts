...
CREATE TABLE `TARI2025` (
  ...
  `CUMPLEXX` enum('','SI','NO','VENCIDO','ERROR_DATOS') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'BANDERA QUE INDICA EL RESULTADO DEL CALCULO DE INDICADOR',
...
/* ACTAULIZACION DICCIONARIO SOLO ES EN LA COLUMNA RESOBTEX EL DECIMAL DE (5,1) A (3,1)*/

  ALTER TABLE TARI2025
 MODIFY COLUMN `RESOBTEX` decimal(3,1) NOT NULL COMMENT 'VALOR DEL RESULTADO OBTENIDO ';