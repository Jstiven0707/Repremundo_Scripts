...
-- Tiempo de generación: 03-01-2025 a las 15:02:59
...
--
-- Estructura de tabla para la tabla `MDOS2025`
--
...
CREATE TABLE `MDOS2025` (
  ...
  `DOCTIPXX` enum('','IMPORTACION','REGISTRO','EXPLOTACION','TRANSITO','OTROS','AFRONEX') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Tipo de operacion',
...
MODIFY COLUMN `DOCTIPXX` enum('','IMPORTACION','REGISTRO','EXPLOTACION','TRANSITO','OTROS','AFRONEX') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Tipo de operacion';