...
/* ACTUALIZACION DICCIONARIO  CLUMNAS ACTUALIZAR    ESTA COLUMNA NO TIENE COMENTARIO `DOCRDTAX`     DOCMTXXX NO ESTA EN LUCID DIAGRAMA*/

ALTER TABLE `MDOS2025`
MODIFY COLUMN `SUCIDXXX` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ID de la sucursal (CIMS0050)';

ALTER TABLE `MDOS2025`
MODIFY COLUMN `DOCTIPXX` enum('','IMPORTACION','REGISTRO','EXPORTACION','TRANSITO','OTROS','AFRONEX') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Tipo de operacion';

ALTER TABLE `MDOS2025`
MODIFY COLUMN`SUBCCOID` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'subcentro de costo (CIPF0049)';

ALTER TABLE `MDOS2025`
MODIFY COLUMN  `PESDOCTR` decimal(16,5) NOT NULL COMMENT 'peso bruto usados del documento de transporte';

/*ALTER TABLE `MDOS2025`
ADD COLUMN DOCHOLEV TIME NOT NULL COMMENT 'Hora de levante';  ya se agrego*/

ALTER TABLE `MDOS2025`
ADD COLUMN IDARCHXX BIGINT NOT NULL COMMENT 'ID del archivo';

ALTER TABLE `MDOS2025`
ADD COLUMN VERDESCA TINYTEXT NOT NULL COMMENT 'Justificacion de la verificacion de carga';

ALTER TABLE `MDOS2025`
MODIFY COLUMN `DOCFEMAX` DATE  NOT NULL COMMENT 'FECHA DE MANIFIESTO';

ALTER TABLE `MDOS2025`
ADD COLUMN MONIDXXX VARCHAR(3) NOT NULL COMMENT'ID de la moneda (CIPO0022)';

ALTER TABLE `MDOS2025`
ADD COLUMN FECTASXX DATE NOT NULL COMMENT 'date fecha de tasa ';

ALTER TABLE `MDOS2025`
ADD COLUMN MDOSOPCR ENUM('','ROJO','NARANJA','VERDE') NOT NULL COMMENT 'BANDERA QUE INDICA LA CRITICIDAD DE LA OPERACION';


ALTER TABLE `MDOS2025`
ADD COLUMN DOCJURAO VARCHAR(3) NOT NULL COMMENT 'jurisdiccion aduanera destino (CIMS0049)';

ALTER TABLE `MDOS2025`
ADD KEY IDX_DOCJURAO(DOCJURAO);

ALTER TABLE `MDOS2025`
ADD COLUMN MDOSBALF ENUM('','SI','NO') NOT NULL COMMENT'bandera que indica si la operacion en lista para facturar';


ALTER TABLE `MDOS2025`
ADD COLUMN MDOSJUFA TINYTEXT NOT NULL COMMENT'Justificacion de facturacion';

ALTER TABLE `MDOS2025`
ADD COLUMN APLPROXX ENUM('','SI','NO') NOT NULL COMMENT 'Bandera Aplica Proyectos';

ALTER TABLE `MDOS2025`
ADD COLUMN COMHFPRO DATETIME  NOT NULL COMMENT 'Fecha y hora de Factura o Proforma';

ALTER TABLE `MDOS2025`
ADD COLUMN COMFAPRO TINYTEXT NOT NULL COMMENT'Numero de la Factura o proforma'
