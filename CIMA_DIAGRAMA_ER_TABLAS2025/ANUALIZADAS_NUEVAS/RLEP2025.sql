...
PERDESXX TINYTEXT NOT NULL COMMENT 'Descripcion del permiso',
FECHEXPD DATE NOT NULL COMMENT 'Fecha De Expedicion',
FECHVIGE DATE  NOT NULL COMMENT 'Fecha de Vigencia',
