...
MDSPIDXX SMALLINT(4) NOT NULL COMMENT 'Id',
MDSPTIPO VARCHAR(30) NOT NULL COMMENT 'Tipo',
MDSPVLRX DECIMAL(18,5) NOT NULL COMMENT 'Valor',
...
PRIMARY KEY (`DOCNROXX`, `CLIIDXXX`,`MDSPIDXX`),
KEY IDX_DOCNROXX(DOCNROXX),
KEY IDX_CLIIDXXX(CLIIDXXX)
)  CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  COMMENT 'OPERACION VS PAGO SISPAP'