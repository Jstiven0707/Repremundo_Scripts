...
-- Tiempo de generación: 05-12-2024 a las 09:06:11
...
CREATE TABLE IF NOT EXISTS `MDOU2024` (
  ...
  `DOCEST2X` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Estado Do Para BackBone',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='Estados de DO';
