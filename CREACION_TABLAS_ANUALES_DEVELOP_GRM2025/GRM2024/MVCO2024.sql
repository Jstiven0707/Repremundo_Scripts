...
-- Tiempo de generación: 05-12-2024 a las 09:15:36
...
--
-- Estructura de tabla para la tabla `MVCO2024`
--

CREATE TABLE IF NOT EXISTS `MVCO2024` (
  ...
  `OBSOBSXX` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Observaciones',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='MVC Observaciones';
