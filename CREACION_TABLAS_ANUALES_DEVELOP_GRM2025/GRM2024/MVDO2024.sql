...
-- Tiempo de generación: 05-12-2024 a las 09:16:11
...
--
-- Estructura de tabla para la tabla `MVDO2024`
--

CREATE TABLE IF NOT EXISTS `MVDO2024` (
  `DOCNROXX` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Numero de DO',
  `IDSECBLO` int NOT NULL COMMENT 'Identificador de secuencia del bloqueo GRM00617',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='Movimiento de Bloqueos DOs';
