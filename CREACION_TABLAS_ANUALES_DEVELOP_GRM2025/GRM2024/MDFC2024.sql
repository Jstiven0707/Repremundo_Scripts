...
-- Tiempo de generación: 05-12-2024 a las 08:57:24
...
CREATE TABLE IF NOT EXISTS `MDFC2024` (
  ...
  `NUMSAEXX` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Numero de la Factura',
  ...
  `CERTAPRO` enum('','SI','NO') COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Certificado Aprobado',
  `RESPNEGX` enum('','CLIENTE','DIAN','SIACO') COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Responsable Negacion',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='Certificados por Facturas Exportaciones';
