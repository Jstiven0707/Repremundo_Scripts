...
-- Tiempo de generación: 05-12-2024 a las 09:01:20
...
CREATE TABLE IF NOT EXISTS `MDOA2024` (
  ...
  `ABROADMO` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Paso Abierto por Admon',
