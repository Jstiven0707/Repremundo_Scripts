...
-- Tiempo de generación: 05-12-2024 a las 08:43:06
...
--
-- Estructura de tabla para la tabla `DSVS2024`
--

CREATE TABLE IF NOT EXISTS `DSVS2024` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci ROW_FORMAT=COMPACT COMMENT='CLIENTE, FACTURA, ITEM VS SERIALES';
