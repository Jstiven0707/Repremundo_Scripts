...
-- Tiempo de generación: 06-12-2024 a las 09:54:44
...
CREATE TABLE IF NOT EXISTS `rfic2024` (
  ...
  `saldhlxx` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'NO' COMMENT 'Registro fotografico DHL',
  ...
  `contxxxx` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
