...
-- Tiempo de generación: 06-12-2024 a las 09:43:34
...
CREATE TABLE IF NOT EXISTS `INDI2024` (
  `DEPIDXXX` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Id de Deposito',
  ...
  `UNIDADMX` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Unidad de medida',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='Indicadores Documentos de Transporte';
