...
-- Tiempo de generación: 06-12-2024 a las 09:56:59
...
--
-- Estructura de tabla para la tabla `ttra2024`
--

CREATE TABLE IF NOT EXISTS `ttra2024` (
  `trazidxx` int NOT NULL AUTO_INCREMENT,
  ...
  `traztype` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Tipo de trazabilidad',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='Trazabilidad de transacciones' AUTO_INCREMENT=130 ;
