...
-- Tiempo de generación: 06-12-2024 a las 09:50:49
...
CREATE TABLE IF NOT EXISTS `mpfa2024` (
  ...
  `regeditx` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Edicion recibo de caja por transferencia',
