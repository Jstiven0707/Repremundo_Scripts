...
-- Tiempo de generación: 12-12-2024 a las 11:58:14
...
CREATE TABLE IF NOT EXISTS `mcid2024` (
  `idingxxx` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Id Automatico',
  ...
  `placaxxx` varchar(7) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Placa',
  `cantpiez` int NOT NULL COMMENT 'Cantidad de piezas/bultos',
  `empidxxx` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Id empresa transportadora',
  `empdesxx` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Nom empresa transportadora',
  `consecxx` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Lista de consecutivos a salir',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='Registro de E y S de vehiculos';
