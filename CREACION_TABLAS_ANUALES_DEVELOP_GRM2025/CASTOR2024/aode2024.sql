...
-- Tiempo de generación: 09-12-2024 a las 09:43:05
...
--
-- Estructura de tabla para la tabla `aode2024`
--

CREATE TABLE IF NOT EXISTS `aode2024` (
  `aodeidxx` int NOT NULL AUTO_INCREMENT COMMENT 'Consecutivo',
  ...
  `clifactx` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Cliente',
  `opopexxx` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Operacion',
  ...
  PRIMARY KEY (`aodeidxx`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='DETALLE FACTURAS OPERACIONES' AUTO_INCREMENT=34 ;
