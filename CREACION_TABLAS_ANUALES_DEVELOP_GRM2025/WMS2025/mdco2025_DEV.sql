...
CREATE TABLE IF NOT EXISTS `mdco2025` (
...
DELIMITER //
CREATE TRIGGER `Trigger_delete_bodega_2025` AFTER DELETE ON `mdco2025`
...
DELIMITER //
CREATE TRIGGER `Trigger_insert_bodega_2025` AFTER INSERT ON `mdco2025`
 FOR EACH ROW BEGIN
...
DELIMITER //
CREATE TRIGGER `Trigger_update_bodega_2025` AFTER UPDATE ON `mdco2025`
 FOR EACH ROW BEGIN
DECLARE descripcion varchar(100);
DECLARE negativo decimal(15,2);
DECLARE name_user varchar(100);
