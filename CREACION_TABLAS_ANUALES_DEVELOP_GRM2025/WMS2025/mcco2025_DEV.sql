...
CREATE TABLE IF NOT EXISTS `mcco2025` (
  ...
  `recidxxx` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Nit Receptor',
  ...
  `comcodc2` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Documento Transporte',
...
--
-- Disparadores `mcco2025`
--

DELIMITER //
CREATE TRIGGER `Trigger_delete_bodega_Cabecera_2025` AFTER DELETE ON `mcco2025`
...
DELIMITER //
CREATE TRIGGER `Trigger_insert_bodega_cabecera_2025` AFTER INSERT ON `mcco2025`
 FOR EACH ROW BEGIN  
...
DELIMITER //
CREATE TRIGGER `Trigger_update_bodega_cabecera_2025` AFTER UPDATE ON `mcco2025`
 FOR EACH ROW BEGIN
DECLARE name_user varchar(100);
