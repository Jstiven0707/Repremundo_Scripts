...
-- Tiempo de generación: 05-12-2024 a las 17:17:15
...
CREATE TABLE IF NOT EXISTS `HEST2024` (
  ...
  `DOIPEDXX` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Pedido',
  ...
  `PAIIDXXX` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Cod Pais Procedencia',
  ...
  `TRAODIXX` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Sucursal Transportadora',
  ...
  `CLIDIRXX` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Direccion Importador',
  ...
  `TIMIDXXX` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Cod Tipo Importador',
  ...
  `LIMESCTX` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Envio de Seriales CT',
  ...
  `LIMFINTM` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Motivo Finaliza temporal',
  ...
  `REGHORXX` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Hora',
  `REGMODXX` date NOT NULL DEFAULT '0000-00-00' COMMENT 'Modificado',
  `REGESTXX` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Estado',
  ...
  `LIMRBEDI` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Robot EDI',
  `LIMRBLEV` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Robot Levante',
  `LIMRBEDF` varchar(254) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Archivo Edi',
  `LIMRBEDR` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Resultado edi del robot',
  `LIMRBAER` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Resultado robot aceptacion',
  `LIMRBLER` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Resultado levante del robot',
  `LIMRBROP` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Recibo oficial de pago',
  `LIMRBROF` date NOT NULL DEFAULT '0000-00-00' COMMENT 'Fecha recibo oficial de pago',
  `LIMRBROH` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Hora recibo oficial de pago',
  `LIMRBROV` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Valor recibo oficial de pago',
  `LIMRBROR` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Resultado recibo oficial de pago',
  `LIMRBLFR` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Frente Robot Levante',
  `LIMRBAFR` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Aceptacion Frente',
  `LIMRBADO` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Robot de Aceptacion Dorsos',
  `LIMRBLDO` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Dorsos Robot Levante',
  `LIMRBLAN` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Version Declaracion Robot Levante',
  `VALORPAG` decimal(17,2) NOT NULL COMMENT 'Valor pagado',
  `DESBANCO` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Descripcion del Banco',
  `TRANSARC` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `LIMCSCXX` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Se utiliza en GRM para determinar si afecta o no la vigencia de TEMPORAL',
  `LIMLIQPR` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Declaracion con Liquidacion Provisional',
  ...
  `LIMDOCSO` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Guarda SI Cuando el Robot Hace Documentos Soporte',
  ...
  `LIMDCUPV` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'NO' COMMENT 'Marca de consumo cupo plan vallejo',
  `LIMAUTPV` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT 'NORMAL' COMMENT 'AutorizaciÃ³n del tramite para cupo plan vallejo',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='Declaraciones Impo';
