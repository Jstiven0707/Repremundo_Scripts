...
-- Tiempo de generación: 05-12-2024 a las 17:12:30
...
CREATE TABLE IF NOT EXISTS `HECA2024` (
  ...
  `IDCAUSAL` int NOT NULL COMMENT 'Id de la Causal',
  `OBSCAUSA` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Observacion de la Causal',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='Detalle Auditoria Causales de Devolucion';
