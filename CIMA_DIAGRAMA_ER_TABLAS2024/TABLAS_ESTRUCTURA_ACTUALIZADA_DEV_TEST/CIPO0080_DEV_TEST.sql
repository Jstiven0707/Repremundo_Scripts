...
--
-- Estructura de tabla para la tabla `CIPO0080`
--

CREATE TABLE `CIPO0080` (
  `RESIDXXX` int (3) NOT NULL COMMENT 'ID DE LA DESCRIPCION',
  `TIPPROID` int(4) NOT NULL COMMENT 'ID DEL TIPO DE PRODUCTO',
  `RESTIPBN` enum('','OBLIGATORIA','POR PRODUCTO') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'bandera que indica el nivel al que se aplica',
