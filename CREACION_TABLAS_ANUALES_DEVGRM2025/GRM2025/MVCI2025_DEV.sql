...
--
-- Estructura de tabla para la tabla `MVCI2025`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT COMMENT='Componentes de Un Item';
