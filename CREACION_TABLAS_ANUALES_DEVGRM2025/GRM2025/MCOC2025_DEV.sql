...
--
-- Estructura de tabla para la tabla `MCOC2025`
--

CREATE TABLE IF NOT EXISTS `MCOC2025` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Ordenes de Compra';
