...
--
-- Estructura de tabla para la tabla `HELC2025`
--
...
CREATE TABLE IF NOT EXISTS `HELC2025` (
  ...
  `BODEGAXX` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nombre de la bodega seleccionada',
  `TIPOLOXX` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nombre tipologia seleccionada',
  `DOCTRAXX` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Numero documento transporte',
  `PLANORXX` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nombre de planta origen ',
  `LINEGOXX` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nombre linea de negocio',
  `ETAXXXXX` date NOT NULL DEFAULT '0000-00-00' COMMENT 'Fecha ETA',
  `DESTINOX` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nombre destino',
  `CANTLINX` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Cantidad de lineas',
  `CANTUNIX` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Cantidad de unidades',
  `AGENTCXX` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Agente de carga',
