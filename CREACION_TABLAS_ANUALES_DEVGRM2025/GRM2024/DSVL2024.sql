...
-- Tiempo de generación: 27-11-2024 a las 09:11:09
...
CREATE TABLE IF NOT EXISTS `DSVL2024` (
  ...
  `LOTITEXX` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Lotes del item',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT COMMENT='CLIENTE, FACTURA, ITEM VS LOTES';
