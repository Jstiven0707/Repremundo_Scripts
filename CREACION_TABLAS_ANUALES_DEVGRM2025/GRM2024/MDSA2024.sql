...
-- Tiempo de generación: 27-11-2024 a las 09:45:22
...
CREATE TABLE IF NOT EXISTS `MDSA2024` (
  ...
  `DEXANIOX` varchar(4) COLLATE utf8_unicode_ci NOT NULL COMMENT 'AÑO DEL DEX CASILLA1',
  `DEXIDDES` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'IDENTIFICACION DEL DESTINATARIO CASILLA 33',
  `DEXDESID` varchar(3) COLLATE utf8_unicode_ci NOT NULL COMMENT 'IDENTIFICACION DEL DESPACHO CASILLA 44',
  `DEXDESDE` tinytext COLLATE utf8_unicode_ci NOT NULL COMMENT 'DESCRIPCION DEL DESPACHO CASILLA 44',
  `DEXPATRA` varchar(3) COLLATE utf8_unicode_ci NOT NULL COMMENT 'CODIGO DEL PAIS DEL TRAMITE CASILLA 51',
  `DEXINCID` varchar(3) COLLATE utf8_unicode_ci NOT NULL COMMENT 'CODIGO INCOTERMS CASILLA 56',
  `DEXANSUS` tinytext COLLATE utf8_unicode_ci NOT NULL COMMENT 'APELLIDOS Y NOMBRES DE QUIEN SUCRIBE CASILLA 1001',
  `DEXTDSUS` varchar(2) COLLATE utf8_unicode_ci NOT NULL COMMENT 'TIPO DE DOCUMENTO DE QUIEN SUCRIBE CASILLA 1002',
  `DEXIDSUS` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'DOCUMENTO DE QUIEN SUCRIBE CASILLA 1003',
  `DEXDVSUS` smallint(2) NOT NULL COMMENT 'DIGITO DE VERIGECACION DE QUIEN SUSCRIBE CASILLA 1004',
  `DEXCRSUS` varchar(5) COLLATE utf8_unicode_ci NOT NULL COMMENT 'CODIGO DE REPRESENTACION DE QUIEN SUSCRIBE CASILLA 1005',
  `DEXORSUS` varchar(5) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ORGANIZACION DE QUIEN SUCRIBE CASILLA 1006',
