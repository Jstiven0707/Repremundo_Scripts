...
-- Tiempo de generación: 30-12-2024 a las 11:37:49
...
CREATE TABLE `MDTD2024` (
  ...
  `BANENVOP` enum('','EXITOSO','FALLIDO') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Bandera que indica si se envió a OPEN',
  `BANENVCI` enum('','EXITOSO','FALLIDO') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL DEFAULT '' COMMENT 'Bandera que indica si se envió a CIMA',
