...
-- Tiempo de generación: 30-12-2024 a las 12:15:04
...
--
-- Estructura de tabla para la tabla `DOCT2024`
--

CREATE TABLE `DOCT2024` (
...
--
-- Indices de la tabla `DOCT2024`
--
ALTER TABLE `DOCT2024`
