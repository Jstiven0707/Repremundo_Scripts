...
CREATE TABLE `DOCC2025` (
  `IDARCHXX` int NOT NULL COMMENT 'ID del paquete',
...
ALTER TABLE `DOCC2025`
  ...
  ADD KEY `TIPOIDXX_2` (`TIPOIDXX`),
  ADD KEY `EMPNITXX_3` (`EMPNITXX`,`TIPOIDXX`,`REGESTXX`),
  ADD KEY `TYPEXXXX` (`TYPEXXXX`),
  ADD KEY `IDARCHXX` (`IDARCHXX`,`TYPEXXXX`),
  ADD KEY `IDARCHXX_2` (`IDARCHXX`,`EMPNITXX`,`AREAIDXX`,`SERIEIDX`,`TIPOIDXX`,`TYPEXXXX`),
  ADD KEY `EMPNITXX_4` (`EMPNITXX`,`AREAIDXX`,`SERIEIDX`,`TIPOIDXX`,`REGESTXX`),
  ADD KEY `EMPNITXX_5` (`EMPNITXX`,`AREAIDXX`,`SERIEIDX`,`REGESTXX`);
...
--
ALTER TABLE `DOCC2025`
  MODIFY `IDARCHXX` int NOT NULL AUTO_INCREMENT COMMENT 'ID del paquete';
COMMIT;
