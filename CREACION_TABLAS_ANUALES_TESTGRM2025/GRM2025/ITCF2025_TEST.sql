...
--
-- Estructura de tabla para la tabla `ITCF2025`
--

CREATE TABLE IF NOT EXISTS `ITCF2025` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Cabecera Factura IT';
