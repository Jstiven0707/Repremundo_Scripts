...
-- Tiempo de generación: 13-12-2024 a las 10:46:19
...
CREATE TABLE IF NOT EXISTS `SHPR2024` (
  `IDXXXXXX` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='productos del embarque' AUTO_INCREMENT=20808 ;
