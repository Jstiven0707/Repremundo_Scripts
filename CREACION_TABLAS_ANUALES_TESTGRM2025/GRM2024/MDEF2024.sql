...
-- Tiempo de generación: 27-11-2024 a las 09:34:34
...
CREATE TABLE IF NOT EXISTS `MDEF2024` (
  ...
  `SUBDOXXX` varchar(250) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'Asunto del DO',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Control de Envio por Operacion por envio de correo de facturacion electronica';
