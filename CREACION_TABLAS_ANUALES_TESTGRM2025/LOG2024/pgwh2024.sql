...
-- Tiempo de generación: 13-12-2024 a las 09:57:36
...
CREATE TABLE IF NOT EXISTS `pgwh2024` (
  ...
  `envifacx` varchar(2) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Se envio desde factura SI/NO',
  `cumplido` varchar(2) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Si se envio cumplido',
  `docadic` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Nom doc que se adiciono',
  ...
  `vehicxxx` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Vehiculo dedicado o periferia',
