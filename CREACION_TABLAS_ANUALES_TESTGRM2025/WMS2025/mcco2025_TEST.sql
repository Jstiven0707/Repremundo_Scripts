...
--
DROP TRIGGER IF EXISTS `Trigger_delete_bodega_Cabecera_2025`;
DELIMITER //
...
//
DELIMITER ;
DROP TRIGGER IF EXISTS `Trigger_insert_bodega_cabecera_2025`;
DELIMITER //
...
//
DELIMITER ;
DROP TRIGGER IF EXISTS `Trigger_update_bodega_cabecera_2025`;
DELIMITER //
