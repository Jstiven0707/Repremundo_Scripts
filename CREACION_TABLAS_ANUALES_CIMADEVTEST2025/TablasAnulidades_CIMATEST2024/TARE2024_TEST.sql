...
-- Tiempo de generación: 22-11-2024 a las 11:53:10
...
--
-- Estructura de tabla para la tabla `TARE2024`
--

DROP TABLE IF EXISTS `TARE2024`;
CREATE TABLE `TARE2024` (
...
--
-- Indices de la tabla `TARE2024`
--
ALTER TABLE `TARE2024`
