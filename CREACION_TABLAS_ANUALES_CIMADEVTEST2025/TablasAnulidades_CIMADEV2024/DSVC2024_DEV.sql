...
-- Tiempo de generación: 20-11-2024 a las 16:17:16
...
CREATE TABLE `DSVC2024` (
  ...
  `DSVCBNAV` enum('','MANUAL','INTEGRACION','DATA ENTRY') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Captura de Datos de Factura',
