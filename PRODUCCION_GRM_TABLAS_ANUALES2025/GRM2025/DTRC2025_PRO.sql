...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Cabecera Datos Documento de Transporte' ROW_FORMAT=DYNAMIC;
...
--
-- Indices de la tabla `DTRC2025`
--
ALTER TABLE `DTRC2025`
  ADD PRIMARY KEY (`DTRCDOTR`,`DTRCNICO`) USING BTREE;
COMMIT;
