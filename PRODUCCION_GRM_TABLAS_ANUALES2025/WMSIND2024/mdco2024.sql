...
-- Tiempo de generación: 10-12-2024 a las 13:53:50
...
--
DELIMITER $$
CREATE TRIGGER `Trigger_delete_bodega_2024` AFTER DELETE ON `mdco2024` FOR EACH ROW DELETE FROM bdfacdep WHERE
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `Trigger_insert_bodega_2024` AFTER INSERT ON `mdco2024` FOR EACH ROW BEGIN
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `Trigger_update_bodega_2024` AFTER UPDATE ON `mdco2024` FOR EACH ROW BEGIN
DECLARE descripcion varchar(100);
DECLARE negativo decimal(15,2);
DECLARE name_user varchar(100);
DECLARE nom_customer varchar(100);
...
--
-- Indices de la tabla `mdco2024`
--
ALTER TABLE `mdco2024`
