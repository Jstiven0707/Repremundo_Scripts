...
CREATE TABLE `JBCF2025` (
  `IDXXXXXX` int(11) NOT NULL COMMENT 'Consecutivo',
  `JBNUMBER` varchar(30) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Numero del trabajo',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Campos personalizados del trabajo';
...
--
-- Indices de la tabla `JBCF2025`
--
ALTER TABLE `JBCF2025`
...
--
-- AUTO_INCREMENT de la tabla `JBCF2025`
--
ALTER TABLE `JBCF2025`
