...
--
DELIMITER $$
CREATE TRIGGER `Trigger_delete_bodega_Cabecera_2024` AFTER DELETE ON `mcco2024` FOR EACH ROW DELETE FROM bdfaccab WHERE
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `Trigger_insert_bodega_cabecera_2024` AFTER INSERT ON `mcco2024` FOR EACH ROW BEGIN  
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `Trigger_update_bodega_cabecera_2024` AFTER UPDATE ON `mcco2024` FOR EACH ROW BEGIN
DECLARE name_user varchar(100);
...
--
-- Indices de la tabla `mcco2024`
--
ALTER TABLE `mcco2024`
