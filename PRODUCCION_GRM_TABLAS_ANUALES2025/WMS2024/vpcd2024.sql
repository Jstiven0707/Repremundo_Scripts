...
-- Tiempo de generación: 10-12-2024 a las 13:49:22
...
--
-- Estructura de tabla para la tabla `vpcd2024`
--

CREATE TABLE `vpcd2024` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Detalle de Vista Previa de Caja';
...
--
-- Indices de la tabla `vpcd2024`
--
ALTER TABLE `vpcd2024`
  ADD PRIMARY KEY (`redccscx`,`csccieca`);
COMMIT;
