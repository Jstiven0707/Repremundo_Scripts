...
-- Tiempo de generación: 10-12-2024 a las 13:19:26
...
--
-- Indices de la tabla `fljd2024`
--
ALTER TABLE `fljd2024`
  ADD PRIMARY KEY (`comidxxx`,`comcodxx`,`comcscxx`,`codfacxx`);
COMMIT;
