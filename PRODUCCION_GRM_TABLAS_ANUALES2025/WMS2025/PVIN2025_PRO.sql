...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Ingreso Propio Ventas Practiko';
...
--
-- Indices de la tabla `PVIN2025`
--
ALTER TABLE `PVIN2025`
  ADD PRIMARY KEY (`IDINFXXX`);
...
--
-- AUTO_INCREMENT de la tabla `PVIN2025`
--
ALTER TABLE `PVIN2025`
