...
--
DELIMITER $$
CREATE TRIGGER `Trigger_delete_bodega_Cabecera_2025` AFTER DELETE ON `mcco2025` FOR EACH ROW DELETE FROM bdfaccab WHERE
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `Trigger_insert_bodega_cabecera_2025` AFTER INSERT ON `mcco2025` FOR EACH ROW BEGIN  
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `Trigger_update_bodega_cabecera_2025` AFTER UPDATE ON `mcco2025` FOR EACH ROW BEGIN
DECLARE name_user varchar(100);
...
--
-- Indices de la tabla `mcco2025`
--
ALTER TABLE `mcco2025`
