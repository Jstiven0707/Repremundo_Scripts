...
--
-- Indices de la tabla `HELI2025`
--
ALTER TABLE `HELI2025`
  ADD PRIMARY KEY (`HELCCSCX`,`TOKIDXXX`,`INOPIDXX`,`FORCALID`),
  ADD KEY `Indice` (`HELCCSCX`),
  ADD KEY `REGESTXX` (`REGESTXX`);
COMMIT;
