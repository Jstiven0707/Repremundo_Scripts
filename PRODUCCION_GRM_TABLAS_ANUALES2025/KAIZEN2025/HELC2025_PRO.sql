...
--
-- Disparadores `HELC2025`
--
DELIMITER $$
CREATE TRIGGER `Trigger_insert_bdhelpde2025` BEFORE INSERT ON `HELC2025` FOR EACH ROW BEGIN
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `Trigger_update_bdhelpde2025` BEFORE UPDATE ON `HELC2025` FOR EACH ROW BEGIN
    DECLARE HELCCSCX varchar(15);
    DECLARE EMPDESXX varchar(100); 
    DECLARE CLADESXX tinytext;
    DECLARE HELPUSRN varchar(100); 
...
--
-- Indices de la tabla `HELC2025`
--
ALTER TABLE `HELC2025`
