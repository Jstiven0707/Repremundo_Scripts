...
-- Tiempo de generación: 10-12-2024 a las 13:13:08
...
--
-- Indices de la tabla `HEST2024`
--
ALTER TABLE `HEST2024`
...
ALTER TABLE `HEST2024` ADD FULLTEXT KEY `LIMROB3X` (`LIMROB3X`);
ALTER TABLE `HEST2024` ADD FULLTEXT KEY `LIMROB4X` (`LIMROB4X`);
COMMIT;
