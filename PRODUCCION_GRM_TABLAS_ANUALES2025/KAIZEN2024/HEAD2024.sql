...
-- Tiempo de generación: 10-12-2024 a las 13:08:16
...
--
-- Estructura de tabla para la tabla `HEAD2024`
--

CREATE TABLE `HEAD2024` (
...
--
-- Indices de la tabla `HEAD2024`
--
ALTER TABLE `HEAD2024`
