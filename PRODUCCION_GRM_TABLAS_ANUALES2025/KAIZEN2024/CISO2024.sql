...
-- Tiempo de generación: 10-12-2024 a las 13:06:18
...
--
-- Estructura de tabla para la tabla `CISO2024`
--

CREATE TABLE `CISO2024` (
...
--
-- Indices de la tabla `CISO2024`
--
ALTER TABLE `CISO2024`
  ADD PRIMARY KEY (`CISCIDXX`,`CISOIDXX`);
COMMIT;
