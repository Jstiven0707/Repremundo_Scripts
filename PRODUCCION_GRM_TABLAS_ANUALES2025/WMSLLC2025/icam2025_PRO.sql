...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='información de ingreso de camiones' ROW_FORMAT=DYNAMIC;
...
ALTER TABLE `icam2025`
  ADD PRIMARY KEY (`idingcam`) USING BTREE;
COMMIT;
