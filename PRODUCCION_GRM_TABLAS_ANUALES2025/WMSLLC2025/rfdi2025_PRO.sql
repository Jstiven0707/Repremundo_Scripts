...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Detalle a Nivel de Inconsistencias ' ROW_FORMAT=DYNAMIC;
...
--
-- Indices de la tabla `rfdi2025`
--
ALTER TABLE `rfdi2025`
...
--
-- AUTO_INCREMENT de la tabla `rfdi2025`
--
ALTER TABLE `rfdi2025`
