...
-- Tiempo de generación: 10-12-2024 a las 13:59:44
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='cabecera contabilidad' ROW_FORMAT=DYNAMIC;
...
ALTER TABLE `mcco2024`
  ADD PRIMARY KEY (`comidxxx`,`comcodxx`,`comcscxx`,`comcsc2x`) USING BTREE;
COMMIT;
