...
-- Tiempo de generación: 10-12-2024 a las 14:04:19
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Detalle de preavisos de llegada' ROW_FORMAT=DYNAMIC;
...
--
-- Indices de la tabla `prad2024`
--
ALTER TABLE `prad2024`
  ADD PRIMARY KEY (`preaviid`,`preavseq`) USING BTREE;
COMMIT;
