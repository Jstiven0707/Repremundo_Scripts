...
-- Tiempo de generación: 10-12-2024 a las 14:05:42
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Eventos de transaccion' ROW_FORMAT=DYNAMIC;
...
--
-- Indices de la tabla `trev2024`
--
ALTER TABLE `trev2024`
  ADD PRIMARY KEY (`trevidxx`) USING BTREE;
...
--
-- AUTO_INCREMENT de la tabla `trev2024`
--
ALTER TABLE `trev2024`
