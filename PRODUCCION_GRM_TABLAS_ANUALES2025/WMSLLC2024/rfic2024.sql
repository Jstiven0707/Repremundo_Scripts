...
-- Tiempo de generación: 10-12-2024 a las 14:05:17
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Cabecera Registro Fotografico e Inconsistencias de la Carga' ROW_FORMAT=DYNAMIC;
...
--
-- Indices de la tabla `rfic2024`
--
ALTER TABLE `rfic2024`
  ADD PRIMARY KEY (`idrficxx`) USING BTREE;
COMMIT;
