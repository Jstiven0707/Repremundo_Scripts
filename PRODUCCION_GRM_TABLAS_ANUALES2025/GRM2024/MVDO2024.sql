...
-- Tiempo de generación: 09-12-2024 a las 19:26:27
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Movimiento de Bloqueos DOs' ROW_FORMAT=DYNAMIC;
...
--
-- Indices de la tabla `MVDO2024`
--
ALTER TABLE `MVDO2024`
  ADD PRIMARY KEY (`IDSECBLO`,`DOCNROXX`) USING BTREE;
COMMIT;
