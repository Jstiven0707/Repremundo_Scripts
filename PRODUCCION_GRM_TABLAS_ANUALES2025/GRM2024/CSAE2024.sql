...
-- Tiempo de generación: 09-12-2024 a las 15:55:08
...
CREATE TABLE `CSAE2024` (
  ...
  `CLIIDXXX` varchar(15) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Nit del Cliente',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Cabecera de Anticipos para Exportación';
...
--
-- Indices de la tabla `CSAE2024`
--
ALTER TABLE `CSAE2024`
  ADD PRIMARY KEY (`ANTIDXXX`);
COMMIT;
