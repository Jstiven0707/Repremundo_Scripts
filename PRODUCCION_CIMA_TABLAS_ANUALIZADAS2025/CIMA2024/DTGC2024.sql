...
-- Tiempo de generación: 11-12-2024 a las 09:34:35
...
CREATE TABLE `DTGC2024` (
  ...
  `DRTCTARI` decimal(12,5) NOT NULL COMMENT 'Tarifa',
  ...
  `DRTCFRPG` decimal(12,5) NOT NULL COMMENT 'Forma de pago del gasto(Prepaid)',
  `DRTCFOPC` decimal(12,5) NOT NULL COMMENT 'Forma de pago del gasto(Collect)',
