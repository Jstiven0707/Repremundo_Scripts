...
-- Tiempo de generación: 11-12-2024 a las 09:28:52
...
CREATE TABLE `CIAC2024` (
  ...
  `AUTVLRXX` decimal(12,2) NOT NULL COMMENT 'Valor de la Autorizacion',
  `FOCOVERX` decimal(4,1) NOT NULL COMMENT 'Version Oferta Comercial',
