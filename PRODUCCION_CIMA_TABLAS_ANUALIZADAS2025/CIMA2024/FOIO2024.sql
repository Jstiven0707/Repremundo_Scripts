...
-- Tiempo de generación: 11-12-2024 a las 12:10:09
...
CREATE TABLE `FOIO2024` (
  ...
  `TOKDESPX` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Descripcion del KPI provisional',
  `VARMEIDP` tinyint NOT NULL COMMENT 'Id de la variable meta provisional',
  `FOIORANG` json NOT NULL COMMENT 'RANGOS',
  `BANINGEX` enum('','SI','NO') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'BANDERA QUE INDICA SI ES UN KPI ESTANDAR',
