...
-- Tiempo de generación: 12-12-2024 a las 08:14:03
...
CREATE TABLE `RCOU2024` (
  ...
  `ISNEWXXX` enum('SI','NO') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT 'NO',
  `SERISGRO` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
