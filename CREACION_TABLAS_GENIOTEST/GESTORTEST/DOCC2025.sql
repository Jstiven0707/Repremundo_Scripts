...
-- Tiempo de generación: 13-01-2025 a las 09:34:01
...
--
-- Base de datos: `GESTORTEST`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `DOCC2025`
--
...
CREATE TABLE `DOCC2025` (
  ...
  `PATHALTX` tinytext NOT NULL COMMENT 'Path alternativo del archivo',
